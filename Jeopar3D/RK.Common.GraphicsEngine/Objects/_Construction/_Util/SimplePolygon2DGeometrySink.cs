...
{
    public class SimplePolygon2DGeometrySink : GeometrySink
    {
        ...
        /// </summary>
        public SimplePolygon2DGeometrySink()
        {
        ...
        /// <exception cref="CommonLibraryException"></exception>
        public void AddArc(ArcSegment arc)
        {
            throw new CommonLibraryException("Geometry type 'Arc' not supported for text geometry building!");
        }
        ...
        {
            throw new CommonLibraryException("Geometry type 'Bezier' not supported for text geometry building!");
        }
        ...
        {
            m_currentPolygonBuilder.Add(new Vector2(point.X, point.Y));
        }
        ...
        {
            throw new CommonLibraryException("Geometry type 'QuadricBezier' not supported for text geometry building!");
        }
        ...
        {
            throw new CommonLibraryException("Geometry type 'QuadricBeziers' not supported for text geometry building!");
        }
        ...
        {
            throw new CommonLibraryException("Geometry type 'Beziers' not supported for text geometry building!");
        }
        ...
        public void AddLines(DrawingPointF[] ointsRef)
        {
            ...
            {
                m_currentPolygonBuilder.Add(new Vector2(ointsRef[loop].X, ointsRef[loop].Y));
            }
        }
        ...
        public void BeginFigure(DrawingPointF startPoint, FigureBegin figureBegin)
        {
            ...
            m_currentPolygonBuilder.Add(new Vector2(startPoint.X, startPoint.Y));
